...
import 'package:qapp/app/features/audit/widgets/action_card.dart';
import 'package:qapp/app/features/audit/widgets/final_audit_card.dart';
import 'package:qapp/app/features/audit/widgets/info_card.dart';
import 'package:qapp/app/features/audit/widgets/menu_card.dart';
import 'package:qapp/app/features/audit/widgets/option_card.dart';
import 'package:qapp/app/features/audit/widgets/second_card.dart';
...
class AuditScreen extends StatefulWidget {
  static const String path = "AuditScreen";
...
class _AuditScreenState extends State<AuditScreen> {
  void initFunction() {
    final views = Provider.of<AuditViewModal>(
      context,
    );
  ...
  @override
  void initState() {
    final views = Provider.of<AuditViewModal>(context, listen: false);
  ...
  Widget timerText({required AuditViewModal views}) {
  ...
  Widget resetTimerText({required AuditViewModal views}) {
    return const Row(
      children: [
        Text("00"),
        SizedBox(
                                    ...
                                    child: GestureDetector(
                                      onTap: () async {
                                        ...
                                        views.UpdateScoreCardAuditStatus(
                                            context, unitCode, styleAuditdata);
  ...
  _buildTimer(BuildContext context, AuditViewModal views) =>
  ...
  _buildSecondRow(BuildContext context, AuditViewModal views,
      ...
      Row(
        ...
        children: [
          ...
          SizedBox(
            ...
            height: 100,
            child: _buildChart(
                (views.remaning), (views.green), (views.yellow), (views.red)),
          ),
          SizedBox(
              child: Column(
            children: [
              _ChartDescription(
                  "Remaining", (views.remaning).toString(), Colors.grey, true),
              const SizedBox(
                height: 5,
              ),
              _ChartDescription(
                  "Green", (views.green).toString(), Colors.green, false),
              const SizedBox(
                height: 5,
              ),
              _ChartDescription(
                  "Yellow", (views.yellow).toString(), Colors.yellow, false),
              const SizedBox(
                height: 5,
              ),
              _ChartDescription(
                  "Red", (views.red).toString(), Colors.red, false),
            ],
          ))
          //_buildChart()
          // chartData()
  ...
  _buildChart(int optCnt, int pass, int yellow, int fail) =>
      BarChart(BarChartData(
          ...
          groupsSpace: 5,
          barGroups: [
            BarChartGroupData(x: optCnt, barRods: [
              BarChartRodData(
                  toY: optCnt.toDouble(),
                  width: 15,
                  color: Colors.grey.withOpacity(0.5))
            ]),
            BarChartGroupData(x: pass, barRods: [
              BarChartRodData(
                  toY: pass.toDouble(), width: 15, color: Colors.green)
            ]),
            BarChartGroupData(x: yellow, barRods: [
              BarChartRodData(
                  toY: yellow.toDouble(), width: 15, color: Colors.yellow)
            ]),
            BarChartGroupData(x: fail, barRods: [
              BarChartRodData(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    if (!views.sessionCompleted)
                      Opacity(
                          opacity: (views.operatorFound &&
                                  views.sleeveAttachmentValue != null &&
                                  views.sleeveValue != null)
                              ? 1.0
                              : 0.45,
                          child: AbsorbPointer(
                              absorbing: (views.operatorFound &&
                                      views.sleeveAttachmentValue != null &&
                                      views.sleeveValue != null)
                                  ? false
                                  : true,
