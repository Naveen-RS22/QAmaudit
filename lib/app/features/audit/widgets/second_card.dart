      ...
      child: Row(
        children: [
          Container(
            ...
            child: widget.views.sleevesData.data == null
          ...
          Container(
            ...
            child: widget.views.sleevesAttachmentData.data == null
                    ...
                    hint: Text(
                      widget.views.currentoperationName.toString().isEmpty
                          ...
                          : widget.views.currentoperationName.length > 25
                              ...
                              : widget.views.currentoperationName,
                      style: TextStyle(
                          color: widget.views.currentoperationName
                                  .toString()
                                  .isEmpty
                              ? Colors.grey
                              : Colors.black),
                ...
                : DropdownButton<String>(
                    ...
                    items: widget.views.sleevesAttachmentData.data?.map((item) {
                      return DropdownMenuItem(
          ...
          Form(
            child: Container(
                ...
                child: TextFormField(
                  ...
                  // initialValue: widget.views.scoreCardData
                  //         .scoreCardDetlModels?[widget.views.auditCount].tagId ??
                  //     "",
                  onChanged: (value) {
                    widget.views.tagNumberOnChange(value);
                  },
          ...
          GestureDetector(
            ...
            child: Container(
                ...
                child: Container(
                  child: const Row(
                    children: [Text("Defect List"), Spacer(), Icon(Icons.menu)],
                  ),
                )),
          ),
        ],
