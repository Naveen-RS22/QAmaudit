...
import 'package:qapp/app/features/dashboard/widgets/audit_summary_card.dart';
import 'package:qapp/app/features/dashboard/widgets/defects_by_parts_chart.dart';
import 'package:qapp/app/features/dashboard/widgets/final_audit_card.dart';
import 'package:qapp/app/features/dashboard/widgets/pieces_status_card.dart';
import 'package:qapp/app/features/dashboard/widgets/time_session_card.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  @override
  void initState() {
    final viewsData = Provider.of<DashboardViewModel>(context, listen: false);
    final inlineView = Provider.of<InlineViewModal>(context, listen: false);

    getRoleCount();
    getRoleAccess();
    viewsData.onGetAuditSummary(context, inlineView);
  ...
  Widget build(BuildContext context) {
    final views = Provider.of<DashboardViewModel>(context);
    final auditviews = Provider.of<AuditViewModal>(context);

    final inlineviews = Provider.of<InlineViewModal>(context);
    final auditview = Provider.of<AuditViewModal>(context);

    final viewsData = Provider.of<DashboardViewModel>(context);
  ...
  _buildBody(
          ...
          DashboardViewModel views,
          AuditViewModal auditviews,
          InlineViewModal inlineviews,
          DashboardViewModel viewsData,
          roleCounts) =>
      Column(
        children: [
          GestureDetector(
  ...
  _buildAppBar(DashboardViewModel view) => GlassmorphicContainer(
  ...
  _buildSecondRow(BuildContext context, DashboardViewModel views) => Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
  ...
  _buildThirdRow(BuildContext context, DashboardViewModel views) => Container(
...
class ApprovalScreen extends StatelessWidget {
  final DashboardViewModel dashView;
