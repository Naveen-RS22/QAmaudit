                ...
                : widget.views.auditStep == 4
                    ...
                    : widget.views.auditStep == 5
                        ...
                        : widget.views.auditStep == 6
                            ...
                            InkWell(
                                onTap: () {
                                  if (widget.views.auditCurrentCheck ==
                                      'pass') {
                                    widget.views.setIsCameraScreen();
                                  } else if (widget.views.auditCurrentCheck ==
                                      'fail') {
                                    if ((widget.views.selectFavorite).isEmpty) {
                                      widget.views
                                          .showErrorAlert('Please add defect');
                                    } else {
                                      widget.views.setIsCameraScreen();
                                    }
                                  }
