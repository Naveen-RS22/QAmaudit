      ...
      children: [
          ...
          children: [
            PageView.builder(
                ...
                onPageChanged: (int index) {
                  ...
                  widget.views.currentPageNotifierOnChange(index);
            ...
            Positioned(
              ...
              child: Padding(
                ...
                child: CirclePageIndicator(
                  ...
                  currentPageNotifier: widget.views.currentPageNotifier,
                ),
              ),
            ),
          ],
        ...
        Row(
          ...
          children: [
            Text(
              roundName == ''
                  ? '${widget.views.scheduleList.data?[widget.views.currentPageNotifier.value].sessionName.toString() ?? '-'} '
                  : '$roundName ',
              style: TextStyle(
                fontSize: 18,
                color: context.res.color.white,
            ...
            GestureDetector(
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const FitAuditScreen(),
                      settings: RouteSettings(
                          arguments: widget.views.scheduleList
                              .data?[widget.views.currentPageNotifier.value])),
