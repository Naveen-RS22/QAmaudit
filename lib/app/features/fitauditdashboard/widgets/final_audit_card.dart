...
class FinalAuditCard extends StatefulWidget {
  final FitDashboardViewModel viewModel;
  final FitDashboardViewModel viewsData;
          ...
          children: [
            Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    widget.viewsData.currentAuditTypeOnchange(context, 'FAF');
                  },
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        color: widget.viewsData.currentAuditType == 'FAF'
                            ? Colors.blue
                            : Colors.white,
                ...
                GestureDetector(
                  onTap: () {
                    widget.viewsData.currentAuditTypeOnchange(context, 'FAG');
                  },
                  child: Container(
                    margin: const EdgeInsets.only(right: 10),
                    padding: const EdgeInsets.symmetric(
                        vertical: 10, horizontal: 10),
                    decoration: BoxDecoration(
                        color: widget.viewsData.currentAuditType == 'FAG'
                            ? Colors.blue
                            : Colors.white,
                        border: Border.all(color: Colors.grey),
                        borderRadius: BorderRadius.circular(5)),
                ...
                GestureDetector(
                  onTap: () {
                    widget.viewsData.currentAuditTypeOnchange(context, 'FAP');
                  },
                  child: Container(
                    padding: const EdgeInsets.symmetric(
                        vertical: 10, horizontal: 10),
                    decoration: BoxDecoration(
                        color: widget.viewsData.currentAuditType == 'FAP'
                            ? Colors.blue
                            : Colors.white,
                        border: Border.all(color: Colors.grey),
                        borderRadius: BorderRadius.circular(5)),
  ...
  _listItem(BuildContext context, int index) {
    return Row(
      ...
      children: [
        ...
        Expanded(
          child: Text(
            widget.viewsData.finalAudit.data?[index].lineName.toString() ?? "",
            style: const TextStyle(
              fontSize: 14,
            ),
          ),
