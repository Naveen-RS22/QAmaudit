...
import 'fit_audit_repo.dart';

class FitAuditRepositoryImpl implements FitAuditRepository {
  ApiService? _apiService;

  FitAuditRepositoryImpl() {
  ...
  Future<ApiResult<DeleteScoreCardHeadByIdModel>> deleteScoreCardHeadByIds(
    ...
    apiData = {
      "appCode": prefs.getString(Constants.qamCode),
      "entityCode": prefs.getString(Constants.entityCode),
      "appEndpoints": "${ApiConstants.DeleteGarFitAuditDataById}$id",
    };
    try {
  ...
  Future<ApiResult<GetAllTop3DefectResponseModel>> getdefectByParts(
    ...
    apiData = {
      ...
      "entityCode": prefs.getString(Constants.entityCode),
      "appEndpoints":
          "${ApiConstants.GarFitAuditGetAllTop3Defect}$unitcode/$audittype/$fromdate/$todate/$auditername/$sewline/$sessionname",
    };
    try {
      final res = await _apiService?.get('', data: apiData);
      return ApiResult.success(
          data: GetAllTop3DefectResponseModel.fromJson(res));
    } catch (e) {
      return ApiResult.failure(error: NetworkExceptions.getDioException(e));
    }
  }
  ...
  Future<ApiResult<OperatorsChart>> getOperatorsCntChart(
      SaveGarFitAuditRequestModel scoreCardData, userName) async {
    SharedPreferences prefs = await SharedPreferenceHelper.prefs;
    Map<String, dynamic> contentData;
    contentData = {'Content-Type': 'application/json; charset=UTF-8'};
    Map<String, dynamic> apiData;
    ...
    String auditType = scoreCardData.auditType.toString();
    String roundname = scoreCardData.sessionName.toString();
    String sewline = scoreCardData.lineCode.toString();
    ...
    apiData = {
      ...
      "entityCode": prefs.getString(Constants.entityCode),
      "appEndpoints":
          "${ApiConstants.GetFitAudiOperatorCnt}/$unitcode/$auditDate/$auditType/$roundname/$sewline/$orderNo/$userName",
    };
    try {
      final res = await _apiService?.get('', data: apiData);
  ...
  Future<ApiResult<SaveGarFitAuditResponseModel>> postAuditDatas(
      SaveGarFitAuditRequestModel scoreCardData) async {
    SharedPreferences prefs = await SharedPreferenceHelper.prefs;
    Map<String, dynamic> contentData;
    contentData = {'Content-Type': 'application/json; charset=UTF-8'};
    ...
    apiData = {
      "appCode": prefs.getString(Constants.qamCode),
      "entityCode": prefs.getString(Constants.entityCode),
      "appEndpoints": ApiConstants.SaveGarFitAudit,
      "bodyContent": jsonEncode(scoreCardData)
    };
    try {
      final res = await _apiService?.post('', data: apiData);
      return ApiResult.success(
          data: SaveGarFitAuditResponseModel.fromJson(res));
    } catch (e) {
      return ApiResult.failure(error: NetworkExceptions.getDioException(e));
    }
  }
  ...
  Future<ApiResult<GetFreqUsedDefectsByParamsModel>>
    ...
    apiData = {
      ...
      "entityCode": prefs.getString(Constants.entityCode),
      "appEndpoints":
          '${ApiConstants.GetFreqUsedFitAuditDefectsByParams}?unitcode=$unitcode&audittype=$audittype&username=$username',
    };
  ...
  Future<ApiResult<GetAllDefectswithFreqUsedDefectsByParamsModel>>
    ...
    apiData = {
      ...
      "entityCode": prefs.getString(Constants.entityCode),
      "appEndpoints":
          '${ApiConstants.GetAllFitAuditDefectswithFreqUsedDefectsByParams}?unitcode=$unitcode&audittype=$audittype&username=$username',
    };
    // String unitcode, String audittype,
    //       String username, String languagecode
    try {
  ...
  Future<ApiResult<UploadImageFitAuditFileListResponse>> postImageUploadData(
      UploadImageFitAuditFileListRequest imgData) async {
    SharedPreferences prefs = await SharedPreferenceHelper.prefs;
    Map<String, dynamic> contentData;
    contentData = {'Content-Type': 'application/json; charset=UTF-8'};
    ...
    apiData = {
      "appCode": prefs.getString(Constants.qamCode),
      "entityCode": prefs.getString(Constants.entityCode),
      "appEndpoints": ApiConstants.UploadImageFitAuditFileList,
    ...
    try {
      ...
      return ApiResult.success(
          data: UploadImageFitAuditFileListResponse.fromJson(res));
    } catch (e) {
      return ApiResult.failure(error: NetworkExceptions.getDioException(e));
    }
  }
  ...
  Future<ApiResult<GetUDMasterByTypeResponseModel>>
      getUDMasterByTypeResponseAPI(String type) async {
    SharedPreferences prefs = await SharedPreferenceHelper.prefs;
    ...
    apiData = {
      "appCode": prefs.getString(Constants.cnfCode),
      "entityCode": prefs.getString(Constants.entityCode),
      "appEndpoints": "${ApiConstants.GetUDMasterByTypes}$type",
    };
    try {
      final res = await _apiService?.get('', data: apiData);
      return ApiResult.success(
          data: GetUDMasterByTypeResponseModel.fromJson(res));
    } catch (e) {
      return ApiResult.failure(error: NetworkExceptions.getDioException(e));
    }
  }
  ...
  Future<ApiResult<CopyFitOrderScheduleResponseModel>>
    ...
    apiData = {
      ...
      "entityCode": prefs.getString(Constants.entityCode),
      "appEndpoints":
          '${ApiConstants.CopyFitOrderSchedule}/$orderschId/$round/$newaudittype',
    };
    try {
      final res = await _apiService?.get('', data: apiData);

      return ApiResult.success(
          data: CopyFitOrderScheduleResponseModel.fromJson(res));
    } catch (e) {
      return ApiResult.failure(error: NetworkExceptions.getDioException(e));
    }
  }
  ...
  Future<ApiResult<GetListGarFitAuditDataByParamsResponseModel>>
    ...
    apiData = {
      ...
      "entityCode": prefs.getString(Constants.entityCode),
      "appEndpoints":
          "${ApiConstants.GetListGarFitAuditDataByParams}/$unitcode/$auditDate/$audittype/$auditername/$orderno/$sewline",
    };
    try {
      final res = await _apiService?.get('', data: apiData);
      return ApiResult.success(
          data: GetListGarFitAuditDataByParamsResponseModel.fromJson(res));
    } catch (e) {
      return ApiResult.failure(error: NetworkExceptions.getDioException(e));
    }
  }
  ...
  Future<ApiResult<GetUDMasterByTypeAuditPcsResponseModel>>
      getUDMasterByTypeResponseAPIauditPcs(String type) async {
    SharedPreferences prefs = await SharedPreferenceHelper.prefs;
    ...
    try {
      final res = await _apiService?.get('', data: apiData);
      return ApiResult.success(
          data: GetUDMasterByTypeAuditPcsResponseModel.fromJson(res));
    } catch (e) {
      return ApiResult.failure(error: NetworkExceptions.getDioException(e));
    }
  }
