...
class PostScoreDataModel {
  bool? isSuccess;
  String? message;
  Datas? data;

  PostScoreDataModel({this.isSuccess, this.message, this.data});

  PostScoreDataModel.fromJson(Map<String, dynamic> json) {
    isSuccess = json['isSuccess'];
    message = json['message'];
    data = json['data'] != null
        ? new Datas.fromJson(jsonDecode(json['data']))
        : null;
  }
