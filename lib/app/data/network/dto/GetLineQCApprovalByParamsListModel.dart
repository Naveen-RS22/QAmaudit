...
class GetLineQCApprovalByParamsListModel {
  bool? isSuccess;
  String? message;
  List<Data>? data;

  GetLineQCApprovalByParamsListModel({this.isSuccess, this.message, this.data});

  GetLineQCApprovalByParamsListModel.fromJson(Map<String, dynamic> json) {
