...
class SaveLineQCApprovalResponseModel {
  bool? isSuccess;
  String? message;
  Data? data;

  SaveLineQCApprovalResponseModel({this.isSuccess, this.message, this.data});

  SaveLineQCApprovalResponseModel.fromJson(Map<String, dynamic> json) {
