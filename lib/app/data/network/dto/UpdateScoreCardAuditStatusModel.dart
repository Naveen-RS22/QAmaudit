...
class UpdateScoreCardAuditStatusModel {
  bool? isSuccess;
  String? message;
  Data? data;

  UpdateScoreCardAuditStatusModel({this.isSuccess, this.message, this.data});

  UpdateScoreCardAuditStatusModel.fromJson(Map<String, dynamic> json) {
