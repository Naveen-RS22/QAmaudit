...
class ScheduleModel {
  bool? isSuccess;
  String? message;
  List<StyleAuditData>? data;

  ScheduleModel({this.isSuccess, this.message, this.data});
  ...
  ScheduleModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      ...
      jsonDecode(json['data']).forEach((v) {
        data!.add(StyleAuditData.fromJson(v));
      });
    }
  }
...
class StyleAuditData {
  ...
  StyleAuditData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
