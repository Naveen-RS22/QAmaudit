...
class SaveWashAprovalResponseModel {
  bool? isSuccess;
  String? message;
  SaveWashAprovalResponseData? data;

  SaveWashAprovalResponseModel({this.isSuccess, this.message, this.data});

  SaveWashAprovalResponseModel.fromJson(Map<String, dynamic> json) {
    isSuccess = json['isSuccess'];
    message = json['message'];
    data = json['data'] != null
        ? SaveWashAprovalResponseData.fromJson(jsonDecode(json['data']))
        : null;
  }
...
class SaveWashAprovalResponseData {
  int? id;
  String? entityID;
  String? buyerCode;
  String? styleNo;
  ...
  SaveWashAprovalResponseData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
