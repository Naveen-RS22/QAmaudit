...
class GetDefectsByCategoryModel {
  bool? isSuccess;
  String? message;
  List<Data>? data;

  GetDefectsByCategoryModel({this.isSuccess, this.message, this.data});

  GetDefectsByCategoryModel.fromJson(Map<String, dynamic> json) {
